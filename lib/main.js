...
var strided = require( '@stdlib/blas-ext-base-slast-index-of-falsy' ).ndarray;
...
*
* var v = slastIndexOfFalsy( [ x ] );
* // returns 3
*/
function slastIndexOfFalsy( arrays ) {
	var x = arrays[ 0 ];
...
module.exports = slastIndexOfFalsy;
